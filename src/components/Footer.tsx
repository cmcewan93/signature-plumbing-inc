        ...
        <div className={styles.footerContent}>
          <div className={styles.contactInfo}>
            <p>
              ...
              <a href="tel:416-450-9504">416-450-9504</a>
            </p>
            <p>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
              </svg>
              <a href="mailto:signatureplumbinggta@gmail.com">signatureplumbinggta@gmail.com</a>
            </p>
            <p>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.socialLinks}>
            <a href="https://www.facebook.com/share/1BBPM9ZBPb/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
              <svg className={styles.socialIcon} viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
              </svg>
            </a>
            <a href="https://instagram.com/signatureplumbinginc" target="_blank" rel="noopener noreferrer">
              <svg className={styles.socialIcon} viewBox="0 0 24 24">
            ...
            <a href="https://tiktok.com/@signatureplumbing" target="_blank" rel="noopener noreferrer">
              <svg className={styles.socialIcon} viewBox="0 0 24 24">
